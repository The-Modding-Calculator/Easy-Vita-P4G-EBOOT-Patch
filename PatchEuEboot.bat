...
:: Patch the elf (EU)
".\RPCS3PatchEboot - TGE\RPCS3PatchEboot.exe" ".\tempElfFiles\base_eboot.elf" ".\Patches - Lipsum\PCSB00245.yml" ".\tempElfFiles\modded_eboot.elf" -FilterByName p4g_ModSupport
