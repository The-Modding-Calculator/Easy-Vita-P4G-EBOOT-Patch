...
:: Patch the elf (Jp)
".\RPCS3PatchEboot - TGE\RPCS3PatchEboot.exe" ".\tempElfFiles\base_eboot.elf" ".\Patches - Lipsum\PCSG00563.yml" ".\tempElfFiles\modded_eboot.elf" -FilterByName p4g_ModSupport
